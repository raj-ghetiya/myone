...
href="chet.php?view='.$friend.'">

<div class=" mx-2 my-1 rounded-full shadow-lg bg-cyan-50 flex justify-between">
   <div class ="flex"><img  class="w-14 h-14 my-2 mx-1 rounded-full" src="image/'.$friend.'.jpg" 
alt="">
            
              <h1 class="mt-5  text-2xl mx-5">'.$friend.'</h1>
...
echo "<li><a data-transition='slide'
href='chet.php?view=$friend'>$friend</a>";
 echo "</ul>";
 $friends = TRUE;
 }
 if (sizeof($following))
